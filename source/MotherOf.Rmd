...
require('here')
print(here())
print(find_root(is_rstudio_project))
knitr::opts_knit$set(root.dir = normalizePath(find_root(is_rstudio_project)))
knitr::opts_chunk$set(root.dir = normalizePath(find_root(is_rstudio_project)))
```
